...
_lr_productions = [
  ...
  ('exp -> atom','exp',1,'p_exp_atom','myyacc.py',127),
  ('exp -> quoted_list','exp',1,'p_exp_qlist','myyacc.py',131),
  ('exp -> call','exp',1,'p_exp_call','myyacc.py',135),
  ('quoted_list -> QUOTE list','quoted_list',2,'p_quoted_list','myyacc.py',139),
  ('list -> LPAREN items RPAREN','list',3,'p_list','myyacc.py',143),
  ('items -> item items','items',2,'p_items','myyacc.py',147),
  ('items -> empty','items',1,'p_items_empty','myyacc.py',151),
  ('empty -> <empty>','empty',0,'p_empty','myyacc.py',155),
  ('item -> atom','item',1,'p_item_atom','myyacc.py',159),
  ('item -> quoted_list','item',1,'p_item_list','myyacc.py',167),
  ('item -> call','item',1,'p_item_call','myyacc.py',171),
  ('item -> empty','item',1,'p_item_empty','myyacc.py',175),
  ('call -> LPAREN SIMB items RPAREN','call',4,'p_call','myyacc.py',179),
  ('atom -> SIMB','atom',1,'p_atom_simbol','myyacc.py',184),
  ('atom -> bool','atom',1,'p_atom_bool','myyacc.py',188),
  ('atom -> NUM','atom',1,'p_atom_num','myyacc.py',192),
  ('atom -> TEXT','atom',1,'p_atom_word','myyacc.py',196),
  ('atom -> <empty>','atom',0,'p_atom_empty','myyacc.py',200),
  ('bool -> TRUE','bool',1,'p_true','myyacc.py',204),
  ('bool -> FALSE','bool',1,'p_false','myyacc.py',208),
  ('atom -> NIL','atom',1,'p_nil','myyacc.py',212),
]
